...
namespace WebApiREST.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebApiREST.Models.EFContext>
    {
        ...
        protected override void Seed(WebApiREST.Models.EFContext context)
        {
